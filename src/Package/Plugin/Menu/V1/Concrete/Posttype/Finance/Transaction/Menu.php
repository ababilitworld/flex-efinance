...
if (!class_exists(__NAMESPACE__.'\Menu')) 
{
    ...
    class Menu extends BaseMenu
    {
        ...
        public function init(array $data = []) : static
        {
            ...
            $this->page_title = 'Transaction';
            $this->menu_title = 'Transaction';
            $this->capability = 'manage_options';
            $this->menu_slug = 'edit.php?post_type='.TransactionPosttype::POSTTYPE;
            $this->callback = null;
            $this->position = 5;
            $this->screen_rules = [
                'post_type' => TransactionPosttype::POSTTYPE,
            ];
