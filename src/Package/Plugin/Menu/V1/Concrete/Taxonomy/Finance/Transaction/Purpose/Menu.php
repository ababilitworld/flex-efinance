...
if (!class_exists(__NAMESPACE__.'\Menu')) 
{
    ...
    class Menu extends BaseMenu
    {
        ...
        public function init(array $data = []) : static
        {
            ...
            $this->page_title = 'Transaction Purpose';
            $this->menu_title = 'Transaction Purpose';
            $this->capability = 'manage_options';
            $this->menu_slug = 'edit-tags.php?taxonomy='.FinanceTransactionPurposeTaxonomy::TAXONOMY;
            $this->callback = null;
            $this->position = 1;
            $this->screen_rules = [
                'taxonomy' => FinanceTransactionPurposeTaxonomy::TAXONOMY,
            ];
