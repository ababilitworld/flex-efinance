<?php
namespace Ababilithub\FlexEFinance\Package\Plugin\Menu\V1\Concrete\Taxonomy\Finance\Transaction\Action;
...
if (!class_exists(__NAMESPACE__.'\Menu')) 
{
    ...
    class Menu extends BaseMenu
    {
        ...
        public function init(array $data = []) : static
        {
            ...
            $this->page_title = 'Transaction Action';
            $this->menu_title = 'Transaction Action';
            $this->capability = 'manage_options';
            $this->menu_slug = 'edit-tags.php?taxonomy='.FinanceTransactionActionTaxonomy::TAXONOMY;
            $this->callback = null;
            $this->position = 4;
            $this->screen_rules = [
                'taxonomy' => FinanceTransactionActionTaxonomy::TAXONOMY,
            ];
