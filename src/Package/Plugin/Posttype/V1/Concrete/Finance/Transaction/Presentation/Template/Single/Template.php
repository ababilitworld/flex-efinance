<?php
namespace Ababilithub\FlexEFinance\Package\Plugin\Posttype\V1\Concrete\Finance\Transaction\Presentation\Template\Single;
...
use Ababilithub\{
    ...
    FlexEFinance\Package\Plugin\Posttype\V1\Concrete\Finance\Transaction\Posttype as LandDeedPosttype,
};
...
class Template 
{
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_style(
            PLUGIN_PRE_HYPH.'-'.LandDeedPosttype::POSTTYPE.'-template-style', 
        ...
        wp_enqueue_script(
            PLUGIN_PRE_HYPH.'-'.LandDeedPosttype::POSTTYPE.'-template-script', 
        ...
        wp_localize_script(
            PLUGIN_PRE_HYPH.'-'.LandDeedPosttype::POSTTYPE.'-template-localize-script', 
                        ...
                        <div class="flsp-main-content">
                            ...
                            <section class="flsp-section">
                                <h2 class="flsp-section-title">
                                    ...
                                    <?php esc_html_e('Location', 'flex-efinance'); ?>
                                </h2>
                                
                                <div class="flsp-location-grid">
                                    <?php
                                    $location_taxonomies = [
                                        'district' => ['icon' => 'fas fa-map', 'label' => __('District', 'flex-efinance')],
                                        'thana' => ['icon' => 'fas fa-map-pin', 'label' => __('Thana', 'flex-efinance')],
                                        'land-mouza' => ['icon' => 'fas fa-vector-square', 'label' => __('Mouza', 'flex-efinance')],
                                        'land-survey' => ['icon' => 'fas fa-drafting-compass', 'label' => __('Survey', 'flex-efinance')]
                                    ];
                            ...
                            <section class="flsp-section">
                                <h2 class="flsp-section-title">
                                    ...
                                    <?php esc_html_e('Deed Information', 'flex-efinance'); ?>
                                </h2>
                                
                                <div class="flsp-details-grid">
                                    <?php 
                                    $property_details = [
                                        'deed-date' => ['icon' => 'fas fa-calendar-check', 'label' => __('Deed Date', 'flex-efinance')],
                                        'deed-number' => ['icon' => 'fas fa-hashtag', 'label' => __('Deed Number', 'flex-efinance')],
                                        'plot-number' => ['icon' => 'fas fa-map-marker-alt', 'label' => __('Plot Number', 'flex-efinance')],
                                        'land-quantity' => ['icon' => 'fas fa-ruler-combined', 'label' => __('Land Area', 'flex-efinance')],
                                    ];
                            ...
                            <section class="flsp-section">
                                <h2 class="flsp-section-title">
                                    ...
                                    <?php esc_html_e('Deed Details', 'flex-efinance'); ?>
                                </h2>
                        ...
                        <aside class="flsp-sidebar">
                            ...
                            <?php if ($docs = get_post_meta($post->ID, 'deed-docs', true)) : ?>
                                <div class="flsp-sidebar-widget">
                                    <h3 class="flsp-widget-title">
                                        ...
                                        <?php esc_html_e('Deed Documents', 'flex-efinance'); ?>
                                    </h3>
                            ...
                            <?php else : ?>
                                <div class="flsp-sidebar-widget">
                                    ...
                                    <p class="flsp-text-center flsp-mb-0"><?php esc_html_e('No documents available', 'flex-efinance'); ?></p>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if ($images = get_post_meta($post->ID, 'deed-images', true)) : ?>
                                <div class="flsp-sidebar-widget">
                                    <h3 class="flsp-widget-title">
                                        ...
                                        <?php esc_html_e('Image Gallery', 'flex-efinance'); ?>
                                    </h3>
                                ...
                                if ($related_deeds->have_posts()) : ?>
                                    <div class="flsp-sidebar-widget">
                                        <h3 class="flsp-widget-title">
                                            ...
                                            <?php esc_html_e('Related Deeds', 'flex-efinance'); ?>
                                        </h3>
