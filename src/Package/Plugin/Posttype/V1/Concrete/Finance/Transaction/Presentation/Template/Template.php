<?php
namespace Ababilithub\FlexEFinance\Package\Plugin\Posttype\Finance\Transaction\Presentation\Template;
...
use const Ababilithub\FlexEFinance\{
    PLUGIN_NAME,
    PLUGIN_DIR,
    PLUGIN_URL,
    PLUGIN_FILE,
