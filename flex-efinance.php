 ...
 * FlexEFinance
 *
 * @package ababilithub/flex-efinance
 *
 * @wordpress-plugin
 * Plugin Name:       FlexEFinance
 * Plugin URI:        https://ababilithub.com/wp-plugin/flex-efinance
